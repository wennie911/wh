...
class CLogicLayer
{
	...
	public:
		...
		//6W+H的缺省问题
		string getDefWhenQuestion();
		string getDefWhereQuestion();
	    string getDefWhoQuestion();
		string getDefHowQuestion();
		string getDefWhatQuestion();
		string getDefWhichQuestion();
		string getDefWhyQuestion();
